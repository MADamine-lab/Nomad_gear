"""
Django settings for nomad_gear project.
"""
...
WSGI_APPLICATION = 'nomad_gear.wsgi.application'
ASGI_APPLICATION = 'nomad_gear.asgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@nomadgear.com')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Nomad Gear API',
    'DESCRIPTION': 'API for Nomad Gear - Outdoor Equipment Rental Platform',
    'VERSION': '1.0.0',
